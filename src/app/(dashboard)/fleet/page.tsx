  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 bg-gray-900">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-semibold text-white">Fleet Management</h1>
          <p className="text-sm text-gray-400">Manage your fleet of vehicles and drivers</p>
        </div>
      ...
      <div className="flex flex-wrap justify-end gap-2">
        <Button variant="outline" className="bg-gray-700 hover:bg-gray-600 text-white text-sm">
