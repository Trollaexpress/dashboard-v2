...
import {
  Home, Users, Truck, Package, Map, BarChart,
  CreditCard, LifeBuoy, Settings, ChevronLeft, ChevronRight, Menu
} from 'lucide-react';
...
export default function Sidebar({
  ...
  return (
    <>
      {isOpen && (
        <div onClick={() => setIsOpen(false)} className="fixed inset-0 bg-black/50 z-40 lg:hidden" />
      )}
